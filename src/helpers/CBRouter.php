...
use aagastya\crudbooster\middlewares\CBAuthAPI;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Route;

class CBRouter
{
    private static $cb_namespace = '\aagastya\crudbooster\controllers';
    ...
    private static function userControllerRoute() {
        Route::group([
            'middleware' => ['web', '\aagastya\crudbooster\middlewares\CBBackend'],
